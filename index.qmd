...
* On Oct. 24, 2024, [Brian O'Meara](https:://brianomeara.info) and [Xingli Giam](https://eeb.utk.edu/people/xingli-giam/), both of the Dept. of Ecology & Evolutionary Biology, University of Tennessee, Knoxville, presented a webinar on applying to grad school in ecology and evolution. See [PDF](2024x10_ApplyingToGradSchool.pdf) or [PowerPoint](2024x10_ApplyingToGradSchool.pptx) files.

{{< video https://www.youtube.com/embed/pTF51989lFU?si=iEaibUQW5t5d_pK
start="2" >}}


Except where noted, the rest of this page contains Brian O'Meara's personal views; if you have suggestions, please see contact info at the bottom of the page.
...
* Though US law on immigration is at a national level, there can still be different handling at local levels. For example, what happens after an arrest can differ depending on whether the relevant law enforcement agency is a partner in the [287(g) program](https://www.ice.gov/identify-and-arrest/287g).
* There is [guidance](https://www.ice.gov/doclib/sevis/pdf/impactLaborStrikesNonimmigrantStudents_FAQ.pdf) on how labor strikes can affect students on an F-1 visa.
